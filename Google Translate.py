...
lab_txt=Label(root,text="Transtalor",font=("Time New Roman",20,"bold"))
lab_txt.place(x=100,y=40,height=100,width=300)
...
lab_txt=Label(root,text="output text",font=("Time New Roman",20,"bold"),fg="Black",bg="red")
